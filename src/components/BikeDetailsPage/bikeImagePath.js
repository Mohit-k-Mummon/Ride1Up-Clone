/*
This is a JavaScript object that stores image paths for different bike models
and color combinations. The object is structured as a nested map with three 
levels: model name, version (e.g., Large, Small), and color. Each color key maps
to an array of image paths. The purpose of this object is to provide an easy 
way to access bike images for use in a web application or other digital 
platform.
*/
export const imageArray = {
	...
	lmtd: {
		XR: {
			'Midnight Gray': [
				'/Bikes/LMTD/XR/gray-1.jpg',
				'/Bikes/LMTD/XR/gray-2.jpg',
				'/Bikes/LMTD/XR/gray-3.jpg',
			],
			SandStone: [
				'/Bikes/LMTD/XR/sand-1.jpg',
				'/Bikes/LMTD/XR/sand-2.jpg',
				'/Bikes/LMTD/XR/sand-3.jpg',
			],
		},
		ST: {
			'Midnight Gray': [
				'/Bikes/LMTD/ST/gray-1.jpg',
				'/Bikes/LMTD/ST/gray-2.jpg',
				'/Bikes/LMTD/ST/gray-3.jpg',
			],
			SandStone: [
				'/Bikes/LMTD/ST/sand-1.jpg',
				'/Bikes/LMTD/ST/sand-2.jpg',
				'/Bikes/LMTD/ST/sand-3.jpg',
			],
		},
	},
	rift: {
	...
	prodigy: {
		...
		XC: {
			'Carbon, Matte': [
				'/Bikes/prodigy/XC/carbon-1.jpg',
				'/Bikes/prodigy/XC/carbon-2.jpg',
				'/Bikes/prodigy/XC/carbon-3.jpg',
			],
			'Chameleon, Gloss': [
				'/Bikes/prodigy/XC/green-1.jpg',
				'/Bikes/prodigy/XC/green-2.jpg',
				'/Bikes/prodigy/XC/green-3.jpg',
			],
		},
		ST: {
			'Carbon, Matte': [
