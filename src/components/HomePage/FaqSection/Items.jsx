const items = [
		...
		content: (
			<>
				<p className='faq-item__content'>
					EBikes come with a range of <span className='bold'>battery sizes</span>,
					accessories, and <span className='bold'>warranty periods</span>, and the life
					span of the battery will vary with how often you ride, your charging habits, and
					the maintenance you invest in your new bike.
				</p>
				<p className='faq-item__content'>
	...
	{
		title: 'How Far Can an Electric Bike Go?',
		content: (
			<>
				<p className='faq-item__content'>
	...
	{
		title: 'Do You Need a License for an Electric Bike?',
		content: (
			<>
				<p className='faq-item__content'>
	...
	{
		title: 'How Fast Can an EBike Go?',
		content: (
			<>
				<p className='faq-item__content'>
					The{' '}
					<span className='bold'>
						speed of an eBike depends a lot on the size of the motor
					</span>{' '}
					on the eBike you decide to purchase. The components built into an eBike monitor
					speed and stop providing electric assistance when you reach a speed threshold,
					helping you ride your eBike safely without compromising efficiency. Most ebikes
					go up to 20 mph and 28 mph on motor assistance.
				</p>
				<p className='faq-item__content'>
	...
	{
		title: 'Are Ebikes Good for Losing Weight?',
		content: (
			<>
				<p className='faq-item__content'>
	...
	{
		title: 'Do Electric Bikes Have Gears?',
		content: (
			<>
				<p className='faq-item__content'>
				...
				<p className='faq-item__content'>
					The accessories and{' '}
					<span className='bold'>gears on our eBikes vary from model to model</span> to
					provide riders with options to find the most suitable and comfortable eBikes for
					their needs. Be sure to compare electric bike models to find the best option for
					your needs.
				</p>
			</>
		),
	...
	{
		title: 'Can You Ride Electric Bikes in the Rain?',
		content: (
			<>
				<p className='faq-item__content'>
	...
	{
		title: 'What is the Best Electric Bike Out Right Now?',
		content: (
			<>
				<p className='faq-item__content'>
				...
				<p className='faq-item__content'>
					<span className='bold'>
						Our Core-5 model is an exceptional value e-bike for first-time riders
					</span>
					, and the 700 Series is a top-of-the-range model loaded with features for
					advanced performance. However, we’d recommend considering what you want to
					prioritize rather than suggesting that one specific model is the best option for
					every electric bike rider.
				</p>
			</>
		),
	},
	{
		title: 'Which Cheap Electric Bike is Best?',
		content: (
			<>
				<p className='faq-item__content'>
	...
	{
		title: 'Is There a Speed Limit on an Electric Bike?',
		content: (
			<>
				<p className='faq-item__content'>
	...
	{
		title: 'What Are the Three Types of E-Bikes?',
		content: (
			<>
				<p className='faq-item__content'>
				...
				<p className='faq-item__content'>
					...
					assist-only electric motor. <br /> Class 2 models incorporate throttles, where
					the motor stops assisting the rider when the bike reaches twenty MPH. <br />{' '}
	...
	{
		title: 'How Far Can You Ride an E-Bike Without Pedaling?',
		content: (
			<>
				<p className='faq-item__content'>
